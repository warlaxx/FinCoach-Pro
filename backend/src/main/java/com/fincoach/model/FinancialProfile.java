...
public class FinancialProfile {
    ...
    public FinancialProfile(Long id, String userId, Double monthlyIncome, Double otherIncome,
        ...
        this.id = id; this.userId = userId; this.monthlyIncome = monthlyIncome;
        this.otherIncome = otherIncome; this.rent = rent; this.utilities = utilities;
        this.insurance = insurance; this.loans = loans; this.subscriptions = subscriptions;
        this.food = food; this.transport = transport; this.leisure = leisure;
        this.clothing = clothing; this.health = health; this.currentSavings = currentSavings;
        this.totalDebt = totalDebt; this.monthlySavingsGoal = monthlySavingsGoal;
        this.financialScore = financialScore; this.savingsRate = savingsRate;
        this.debtRatio = debtRatio; this.createdAt = createdAt; this.updatedAt = updatedAt;
    }
    ...
    public void setClothing(Double clothing) { this.clothing = clothing; }
    ...
    public void setMonthlySavingsGoal(Double monthlySavingsGoal) { this.monthlySavingsGoal = monthlySavingsGoal; }
    public String getFinancialScore() { return financialScore; }
    public void setFinancialScore(String financialScore) { this.financialScore = financialScore; }
